...
assert(
  ...
  "focus overlay return button must split localized prefix and space like the tab overlay",
);
...
assert(files.focusOverlay.includes('"focus.dragToOrbit"'), "focus overlay needs the localized first-drag hint");
...
assert(files.focusPanels.includes("copy.overviewHeading"), "focus left panel must label Overview through localized copy");
assert(files.focusPanels.includes("copy.tagsHeading"), "focus left panel must label Tags through localized copy");
assert(files.focusPanels.includes("copy.storyHeading"), "focus right panel must label Story through localized copy");
