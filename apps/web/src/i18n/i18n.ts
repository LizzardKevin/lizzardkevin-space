  ...
  zh: {
    translation: {
      ...
      webgpu: {
        required: "需要 WebGPU",
        unsupported:
          "你的浏览器不支持 WebGPU。请使用最新版 Chrome / Edge 113+、Safari 26+ 或 Firefox 141+（Windows）。",
      },
      error: {
        appTitle: "APP ERROR",
  ...
  en: {
    translation: {
      ...
      webgpu: {
        ...
        unsupported:
          "Your browser does not support WebGPU. Please use the latest Chrome / Edge 113+, Safari 26+, or Firefox 141+ on Windows.",
      },
      error: {
        appTitle: "APP ERROR",
