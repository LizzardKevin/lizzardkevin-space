...
assert(files.mobileExperience.includes("<SkillsDocument copy={copy.skills} language={language}"), "Skills.md must render localized skill summaries");
...
assert(files.mobileExperience.includes("setExpanded((open) => !open)"), "TerminalFold must toggle state through React for animated expand and collapse");
